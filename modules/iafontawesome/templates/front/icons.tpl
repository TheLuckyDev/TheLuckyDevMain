<section id="new-icon-list">
<h2 class="page-header"><i class="fa fa-flag"></i> Icons all</h2>

	<h2>66 New Icons in 4.4</h2>
  <div class="row">
      <div class="span3"><i class="fa fa-500px"></i> fa-500px</div>
      <div class="span3"><i class="fa fa-amazon"></i> fa-amazon</div>
      <div class="span3"><i class="fa fa-balance-scale"></i> fa-balance-scale</div>
      <div class="span3"><i class="fa fa-battery-empty"></i> fa-battery-0 <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-battery-quarter"></i> fa-battery-1 <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-battery-half"></i> fa-battery-2 <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-battery-three-quarters"></i> fa-battery-3 <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-battery-full"></i> fa-battery-4 <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-battery-empty"></i> fa-battery-0</div>
      <div class="span3"><i class="fa fa-battery-full"></i> fa-battery-full</div>
      <div class="span3"><i class="fa fa-battery-half"></i> fa-battery-half</div>
      <div class="span3"><i class="fa fa-battery-quarter"></i> fa-battery-quarter</div>
      <div class="span3"><i class="fa fa-battery-three-quarters"></i> fa-battery-three-quarters</div>
      <div class="span3"><i class="fa fa-black-tie"></i> fa-black-tie</div>
      <div class="span3"><i class="fa fa-calendar-check-o"></i> fa-calendar-check-o</div>
			<div class="span3"><i class="fa fa-calendar-minus-o"></i> fa-calendar-minus-o</div>
      <div class="span3"><i class="fa fa-calendar-plus-o"></i> fa-calendar-plus-o</div>
      <div class="span3"><i class="fa fa-calendar-times-o"></i> fa-calendar-times-o</div>
      <div class="span3"><i class="fa fa-cc-diners-club"></i> fa-cc-diners-club</div>
      <div class="span3"><i class="fa fa-cc-jcb"></i> fa-cc-jcb</div>
      <div class="span3"><i class="fa fa-chrome"></i> fa-chrome</div>
      <div class="span3"><i class="fa fa-clone"></i> fa-clone</div>
      <div class="span3"><i class="fa fa-commenting"></i> fa-commenting</div>
      <div class="span3"><i class="fa fa-commenting-o"></i> fa-commenting-o</div>
      <div class="span3"><i class="fa fa-contao"></i> fa-contao</div>
      <div class="span3"><i class="fa fa-creative-commons"></i> fa-creative-commons</div>
      <div class="span3"><i class="fa fa-expeditedssl"></i> fa-expeditedssl</div>
      <div class="span3"><i class="fa fa-firefox"></i> fa-firefox</div>
      <div class="span3"><i class="fa fa-fonticons"></i> fa-fonticons</div>
      <div class="span3"><i class="fa fa-genderless"></i> fa-genderless</div>
      <div class="span3"><i class="fa fa-get-pocket"></i> fa-get-pocket</div>
      <div class="span3"><i class="fa fa-gg"></i> fa-gg</div>
      <div class="span3"><i class="fa fa-gg-circle"></i> fa-gg-circle</div>
      <div class="span3"><i class="fa fa-hand-rock-o"></i> fa-hand-grab-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-hand-lizard-o"></i> fa-hand-lizard-o</div>
      <div class="span3"><i class="fa fa-hand-paper-o"></i> fa-hand-paper-o</div>
      <div class="span3"><i class="fa fa-hand-peace-o"></i> fa-hand-peace-o</div>
      <div class="span3"><i class="fa fa-hand-pointer-o"></i> fa-hand-pointer-o</div>
      <div class="span3"><i class="fa fa-hand-rock-o"></i> fa-hand-rock-o</div>
      <div class="span3"><i class="fa fa-hand-scissors-o"></i> fa-hand-scissors-o</div>
      <div class="span3"><i class="fa fa-hand-spock-o"></i> fa-hand-spock-o</div>
			<div class="span3"><i class="fa fa-hand-paper-o"></i> fa-hand-stop-o <span>(alias)</span></div>
			<div class="span3"><i class="fa fa-hourglass"></i> fa-hourglass</div>
			<div class="span3"><i class="fa fa-hourglass-start"></i> fa-hourglass-1 <span>(alias)</span></div>
			<div class="span3"><i class="fa fa-hourglass-half"></i> fa-hourglass-2 <span>(alias)</span></div>
			<div class="span3"><i class="fa fa-hourglass-end"></i> fa-hourglass-3 <span>(alias)</span></div>
			<div class="span3"><i class="fa fa-hourglass-end"></i> fa-hourglass-end</div>
			<div class="span3"><i class="fa fa-hourglass-half"></i> fa-hourglass-half</div>
			<div class="span3"><i class="fa fa-hourglass-o"></i> fa-hourglass-o</div>
			<div class="span3"><i class="fa fa-hourglass-start"></i> fa-hourglass-start</div>
			<div class="span3"><i class="fa fa-houzz"></i> fa-houzz</div>
			<div class="span3"><i class="fa fa-i-cursor"></i> fa-i-cursor</div>
			<div class="span3"><i class="fa fa-industry"></i> fa-industry</div>
			<div class="span3"><i class="fa fa-internet-explorer"></i> fa-internet-explorer</div>
			<div class="span3"><i class="fa fa-map"></i> fa-map</div>
			<div class="span3"><i class="fa fa-map-o"></i> fa-map-o</div>
			<div class="span3"><i class="fa fa-map-pin"></i> fa-map-pin</div>
			<div class="span3"><i class="fa fa-map-signs"></i> fa-map-signs</div>
			<div class="span3"><i class="fa fa-mouse-pointer"></i> fa-mouse-pointer</div>
			<div class="span3"><i class="fa fa-object-group"></i> fa-object-group</div>
			<div class="span3"><i class="fa fa-object-ungroup"></i> fa-object-ungroup</div>
			<div class="span3"><i class="fa fa-odnoklassniki"></i> fa-odnoklassniki</div>
			<div class="span3"><i class="fa fa-odnoklassniki-square"></i> fa-odnoklassniki-square</div>
			<div class="span3"><i class="fa fa-opencart"></i> fa-opencart</div>
			<div class="span3"><i class="fa fa-opera"></i> fa-opera</div>
			<div class="span3"><i class="fa fa-optin-monster"></i> fa-optin-monster</div>
			<div class="span3"><i class="fa fa-registered"></i> fa-registered</div>
			<div class="span3"><i class="fa fa-safari"></i> fa-safari</div>
			<div class="span3"><i class="fa fa-sticky-note"></i> fa-sticky-note</div>
			<div class="span3"><i class="fa fa-sticky-note-o"></i> fa-sticky-note-o</div>
			<div class="span3"><i class="fa fa-television"></i> fa-television</div>
			<div class="span3"><i class="fa fa-trademark"></i> fa-trademark</div>
			<div class="span3"><i class="fa fa-tripadvisor"></i> fa-tripadvisor</div>
			<div class="span3"><i class="fa fa-television"></i> fa-tv <span>(alias)</span></div>
			<div class="span3"><i class="fa fa-vimeo"></i> fa-vimeo</div>
			<div class="span3"><i class="fa fa-wikipedia-w"></i> fa-wikipedia-w</div>
			<div class="span3"><i class="fa fa-y-combinator"></i> fa-y-combinator</div>
			<div class="span3"><i class="fa fa-y-combinator"></i> fa-yc <span>(alias)</span></div>
  ...
  <div class="row">
      <div class="span3"><i class="fa fa-bed"></i> fa-bed</div>
      <div class="span3"><i class="fa fa-buysellads"></i> fa-buysellads</div>
      <div class="span3"><i class="fa fa-cart-arrow-down"></i> fa-cart-arrow-down</div>
      <div class="span3"><i class="fa fa-cart-plus"></i> fa-cart-plus</div>
      <div class="span3"><i class="fa fa-connectdevelop"></i> fa-connectdevelop</div>
      <div class="span3"><i class="fa fa-dashcube"></i> fa-dashcube</div>
      <div class="span3"><i class="fa fa-diamond"></i> fa-diamond</div>
      <div class="span3"><i class="fa fa-facebook-official"></i> fa-facebook-official</div>
      <div class="span3"><i class="fa fa-forumbee"></i> fa-forumbee</div>
      <div class="span3"><i class="fa fa-heartbeat"></i> fa-heartbeat</div>
      <div class="span3"><i class="fa fa-bed"></i> fa-hotel <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-leanpub"></i> fa-leanpub</div>
      <div class="span3"><i class="fa fa-mars"></i> fa-mars</div>
      <div class="span3"><i class="fa fa-mars-double"></i> fa-mars-double</div>
      <div class="span3"><i class="fa fa-mars-stroke"></i> fa-mars-stroke</div>
			<div class="span3"><i class="fa fa-mars-stroke-h"></i> fa-mars-stroke-h</div>
      <div class="span3"><i class="fa fa-mars-stroke-v"></i> fa-mars-stroke-v</div>
      <div class="span3"><i class="fa fa-medium"></i> fa-medium</div>
      <div class="span3"><i class="fa fa-mercury"></i> fa-mercury</div>
      <div class="span3"><i class="fa fa-motorcycle"></i> fa-motorcycle</div>
      <div class="span3"><i class="fa fa-neuter"></i> fa-neuter</div>
      <div class="span3"><i class="fa fa-pinterest-p"></i> fa-pinterest-p</div>
      <div class="span3"><i class="fa fa-sellsy"></i> fa-sellsy</div>
      <div class="span3"><i class="fa fa-server"></i> fa-server</div>
      <div class="span3"><i class="fa fa-ship"></i> fa-ship</div>
      <div class="span3"><i class="fa fa-shirtsinbulk"></i> fa-shirtsinbulk</div>
      <div class="span3"><i class="fa fa-simplybuilt"></i> fa-simplybuilt</div>
      <div class="span3"><i class="fa fa-skyatlas"></i> fa-skyatlas</div>
      <div class="span3"><i class="fa fa-street-view"></i> fa-street-view</div>
      <div class="span3"><i class="fa fa-subway"></i> fa-subway</div>
      <div class="span3"><i class="fa fa-train"></i> fa-train</div>
      <div class="span3"><i class="fa fa-transgender"></i> fa-transgender</div>
      <div class="span3"><i class="fa fa-transgender-alt"></i> fa-transgender-alt</div>
      <div class="span3"><i class="fa fa-user-plus"></i> fa-user-plus</div>
      <div class="span3"><i class="fa fa-user-secret"></i> fa-user-secret</div>
      <div class="span3"><i class="fa fa-user-times"></i> fa-user-times</div>
      <div class="span3"><i class="fa fa-venus"></i> fa-venus</div>
      <div class="span3"><i class="fa fa-venus-double"></i> fa-venus-double</div>
      <div class="span3"><i class="fa fa-venus-mars"></i> fa-venus-mars</div>
      <div class="span3"><i class="fa fa-viacoin"></i> fa-viacoin</div>
      <div class="span3"><i class="fa fa-whatsapp"></i> fa-whatsapp</div>
      
  </div>
	<br />
	<h2>40 New Icons in 4.2</h2>
  <div class="row">
      <div class="span3"><i class="fa fa-angellist"></i> fa-angellist</div>
      <div class="span3"><i class="fa fa-area-chart"></i> fa-area-chart</div>
      <div class="span3"><i class="fa fa-at"></i> fa-at</div>
      <div class="span3"><i class="fa fa-bell-slash"></i> fa-bell-slash</div>
      <div class="span3"><i class="fa fa-bell-slash-o"></i> fa-bell-slash-o</div>
      <div class="span3"><i class="fa fa-bicycle"></i> fa-bicycle</div>
      <div class="span3"><i class="fa fa-binoculars"></i> fa-binoculars</div>
      <div class="span3"><i class="fa fa-birthday-cake"></i> fa-birthday-cake</div>
      <div class="span3"><i class="fa fa-bus"></i> fa-bus</div>
      <div class="span3"><i class="fa fa-calculator"></i> fa-calculator</div>
      <div class="span3"><i class="fa fa-cc"></i> fa-cc</div>
      <div class="span3"><i class="fa fa-cc-amex"></i> fa-cc-amex</div>
      <div class="span3"><i class="fa fa-cc-discover"></i> fa-cc-discover</div>
      <div class="span3"><i class="fa fa-cc-mastercard"></i> fa-cc-mastercard</div>
      <div class="span3"><i class="fa fa-cc-paypal"></i> fa-cc-paypal</div>
      <div class="span3"><i class="fa fa-cc-stripe"></i> fa-cc-stripe</div>
      <div class="span3"><i class="fa fa-cc-visa"></i> fa-cc-visa</div>
      <div class="span3"><i class="fa fa-copyright"></i> fa-copyright</div>
      <div class="span3"><i class="fa fa-eyedropper"></i> fa-eyedropper</div>
      <div class="span3"><i class="fa fa-futbol-o"></i> fa-futbol-o</div>
      <div class="span3"><i class="fa fa-google-wallet"></i> fa-google-wallet</div>
      <div class="span3"><i class="fa fa-ils"></i> fa-ils</div>
      <div class="span3"><i class="fa fa-ioxhost"></i> fa-ioxhost</div>
      <div class="span3"><i class="fa fa-lastfm"></i> fa-lastfm</div>
      <div class="span3"><i class="fa fa-file-code-o"></i> fa-file-code-o</div>
      <div class="span3"><i class="fa fa-lastfm-square"></i> fa-lastfm-square</div>
      <div class="span3"><i class="fa fa-line-chart"></i> fa-line-chart</div>
      <div class="span3"><i class="fa fa-meanpath"></i> fa-meanpath</div>
      <div class="span3"><i class="fa fa-newspaper-o"></i> fa-newspaper-o</div>
      <div class="span3"><i class="fa fa-paint-brush"></i> fa-paint-brush</div>
      <div class="span3"><i class="fa fa fa-paypal"></i> fa fa-paypal</div>
      <div class="span3"><i class="fa fa-pie-chart"></i> fa-pie-chart</div>
      <div class="span3"><i class="fa fa-plug"></i> fa-plug</div>
      <div class="span3"><i class="fa fa-shekel"></i> fa-shekel <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-sheqel"></i> fa-sheqel <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-slideshare"></i> fa-slideshare</div>
      <div class="span3"><i class="fa fa-soccer-ball-o"></i> fa-soccer-ball-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-toggle-off"></i> fa-toggle-off</div>
      <div class="span3"><i class="fa fa-toggle-on"></i> fa-toggle-on</div>
      <div class="span3"><i class="fa fa-trash"></i> fa-trash</div>
      <div class="span3"><i class="fa fa-tty"></i> fa-tty</div>
      <div class="span3"><i class="fa fa-twitch"></i> fa-twitch</div>
      <div class="span3"><i class="fa fa-wifi"></i> fa-wifi</div>
      <div class="span3"><i class="fa fa-yelp"></i> fa-yelp</div>
      
  </div>
	<br />
  <h2>71 New Icons in 4.1</h2>
  <div class="row">
      <div class="span3"><i class="fa fa-automobile"></i> fa-automobile <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-bank"></i> fa-bank <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-behance"></i> fa-behance</div>
      <div class="span3"><i class="fa fa-behance-square"></i> fa-behance-square</div>
      <div class="span3"><i class="fa fa-bomb"></i> fa-bomb</div>
      <div class="span3"><i class="fa fa-building"></i> fa-building</div>
      <div class="span3"><i class="fa fa-cab"></i> fa-cab <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-car"></i> fa-car</div>
      <div class="span3"><i class="fa fa-child"></i> fa-child</div>
      <div class="span3"><i class="fa fa-circle-o-notch"></i> fa-circle-o-notch</div>
      <div class="span3"><i class="fa fa-circle-thin"></i> fa-circle-thin</div>
      <div class="span3"><i class="fa fa-codepen"></i> fa-codepen</div>
      <div class="span3"><i class="fa fa-cube"></i> fa-cube</div>
      <div class="span3"><i class="fa fa-cubes"></i> fa-cubes</div>
      <div class="span3"><i class="fa fa-database"></i> fa-database</div>
      <div class="span3"><i class="fa fa-delicious"></i> fa-delicious</div>
      <div class="span3"><i class="fa fa-deviantart"></i> fa-deviantart</div>
      <div class="span3"><i class="fa fa-digg"></i> fa-digg</div>
      <div class="span3"><i class="fa fa-drupal"></i> fa-drupal</div>
      <div class="span3"><i class="fa fa-empire"></i> fa-empire</div>
      <div class="span3"><i class="fa fa-envelope-square"></i> fa-envelope-square</div>
      <div class="span3"><i class="fa fa-fax"></i> fa-fax</div>
      <div class="span3"><i class="fa fa-file-archive-o"></i> fa-file-archive-o</div>
      <div class="span3"><i class="fa fa-file-audio-o"></i> fa-file-audio-o</div>
      <div class="span3"><i class="fa fa-file-code-o"></i> fa-file-code-o</div>
      <div class="span3"><i class="fa fa-file-excel-o"></i> fa-file-excel-o</div>
      <div class="span3"><i class="fa fa-file-image-o"></i> fa-file-image-o</div>
      <div class="span3"><i class="fa fa-file-movie-o"></i> fa-file-movie-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</div>
      <div class="span3"><i class="fa fa-file-photo-o"></i> fa-file-photo-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-file-picture-o"></i> fa-file-picture-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>
      <div class="span3"><i class="fa fa-file-sound-o"></i> fa-file-sound-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-file-video-o"></i> fa-file-video-o</div>
      <div class="span3"><i class="fa fa-file-word-o"></i> fa-file-word-o</div>
      <div class="span3"><i class="fa fa-file-zip-o"></i> fa-file-zip-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-ge"></i> fa-ge <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-git"></i> fa-git</div>
      <div class="span3"><i class="fa fa-git-square"></i> fa-git-square</div>
      <div class="span3"><i class="fa fa-google"></i> fa-google</div>
      <div class="span3"><i class="fa fa-graduation-cap"></i> fa-graduation-cap</div>
      <div class="span3"><i class="fa fa-hacker-news"></i> fa-hacker-news</div>
      <div class="span3"><i class="fa fa-header"></i> fa-header</div>
      <div class="span3"><i class="fa fa-history"></i> fa-history</div>
      <div class="span3"><i class="fa fa-institution"></i> fa-institution <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-joomla"></i> fa-joomla</div>
      <div class="span3"><i class="fa fa-jsfiddle"></i> fa-jsfiddle</div>
      <div class="span3"><i class="fa fa-language"></i> fa-language</div>
      <div class="span3"><i class="fa fa-life-bouy"></i> fa-life-bouy <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-life-ring"></i> fa-life-ring</div>
      <div class="span3"><i class="fa fa-life-saver"></i> fa-life-saver <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-mortar-board"></i> fa-mortar-board <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-openid"></i> fa-openid</div>
      <div class="span3"><i class="fa fa-paper-plane"></i> fa-paper-plane</div>
      <div class="span3"><i class="fa fa-paper-plane-o"></i> fa-paper-plane-o</div>
      <div class="span3"><i class="fa fa-paragraph"></i> fa-paragraph</div>
      <div class="span3"><i class="fa fa-paw"></i> fa-paw</div>
      <div class="span3"><i class="fa fa-pied-piper"></i> fa-pied-piper</div>
      <div class="span3"><i class="fa fa-pied-piper-alt"></i> fa-pied-piper-alt</div>
      <div class="span3"><i class="fa fa-pied-piper-square"></i> fa-pied-piper-square <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-qq"></i> fa-qq</div>
      <div class="span3"><i class="fa fa-ra"></i> fa-ra <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-rebel"></i> fa-rebel</div>
      <div class="span3"><i class="fa fa-recycle"></i> fa-recycle</div>
      <div class="span3"><i class="fa fa-reddit"></i> fa-reddit</div>
      <div class="span3"><i class="fa fa-reddit-square"></i> fa-reddit-square</div>
      <div class="span3"><i class="fa fa-send"></i> fa-send <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-send-o"></i> fa-send-o <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-share-alt"></i> fa-share-alt</div>
      <div class="span3"><i class="fa fa-share-alt-square"></i> fa-share-alt-square</div>
      <div class="span3"><i class="fa fa-slack"></i> fa-slack</div>
      <div class="span3"><i class="fa fa-sliders"></i> fa-sliders</div>
      <div class="span3"><i class="fa fa-soundcloud"></i> fa-soundcloud</div>
      <div class="span3"><i class="fa fa-space-shuttle"></i> fa-space-shuttle</div>
      <div class="span3"><i class="fa fa-spoon"></i> fa-spoon</div>
      <div class="span3"><i class="fa fa-spotify"></i> fa-spotify</div>
      <div class="span3"><i class="fa fa-steam"></i> fa-steam</div>
      <div class="span3"><i class="fa fa-steam-square"></i> fa-steam-square</div>
      <div class="span3"><i class="fa fa-stumbleupon"></i> fa-stumbleupon</div>
      <div class="span3"><i class="fa fa-stumbleupon-circle"></i> fa-stumbleupon-circle</div>
      <div class="span3"><i class="fa fa-support"></i> fa-support <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-taxi"></i> fa-taxi</div>
      <div class="span3"><i class="fa fa-tencent-weibo"></i> fa-tencent-weibo</div>
      <div class="span3"><i class="fa fa-tree"></i> fa-tree</div>
      <div class="span3"><i class="fa fa-university"></i> fa-university</div>
      <div class="span3"><i class="fa fa-vine"></i> fa-vine</div>
      <div class="span3"><i class="fa fa-wechat"></i> fa-wechat <span>(alias)</span></div>
      <div class="span3"><i class="fa fa-weixin"></i> fa-weixin</div>
      <div class="span3"><i class="fa fa-wordpress"></i> fa-wordpress</div>
      <div class="span3"><i class="fa fa-yahoo"></i> fa-yahoo</div>
  </div>
</section>
<br />
<section id="web-application">
  ...
  <div class="row">
      ...
      <div class="span3"><i class="fa fa-automobile"></i> fa-automobile <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-ban"></i> fa-ban</div>
      <div class="span3"><i class="fa fa-bank"></i> fa-bank <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-cab"></i> fa-cab <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-file-excel-o"></i> fa-file-excel-o</div>
      <div class="span3"><i class="fa fa-file-image-o"></i> fa-file-image-o</div>
      <div class="span3"><i class="fa fa-file-movie-o"></i> fa-file-movie-o <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-file-pdf-o"></i> fa-file-pdf-o</div>
      <div class="span3"><i class="fa fa-file-photo-o"></i> fa-file-photo-o <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-file-picture-o"></i> fa-file-picture-o <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-file-powerpoint-o"></i> fa-file-powerpoint-o</div>
      <div class="span3"><i class="fa fa-file-sound-o"></i> fa-file-sound-o <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-file-video-o"></i> fa-file-video-o</div>
      <div class="span3"><i class="fa fa-file-word-o"></i> fa-file-word-o</div>
      <div class="span3"><i class="fa fa-file-zip-o"></i> fa-file-zip-o <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-image"></i> fa-image <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-institution"></i> fa-institution <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-life-bouy"></i> fa-life-bouy <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-life-ring"></i> fa-life-ring</div>
      <div class="span3"><i class="fa fa-life-saver"></i> fa-life-saver <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-mail-reply-all"></i> fa-mail-reply-all <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-mortar-board"></i> fa-mortar-board <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-music"></i> fa-music</div>
      <div class="span3"><i class="fa fa-navicon"></i> fa-navicon <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-paper-plane"></i> fa-paper-plane</div>
      <div class="span3"><i class="fa fa-paper-plane-o"></i> fa-paper-plane-o</div>
      <div class="span3"><i class="fa fa-paw"></i> fa-paw</div>
      ...
      <div class="span3"><i class="fa fa-photo"></i> fa-photo <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-reorder"></i> fa-reorder <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-send"></i> fa-send <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-send-o"></i> fa-send-o <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-support"></i> fa-support <span class="text-muted">(alias)</span></div>
...
Media Buttons" setting. We will not use hacks to force them to display. Please report an issue with Adblock Plus if you believe this to be
an error. To work around this, you'll need to modify the social icon class names.
  ...
  <div class="row fontawesome-icon-list">
      ...
      <div class="span3"><i class="fa fa-ge"></i> fa-ge <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-git"></i> fa-git</div>
      <div class="span3"><i class="fa fa-git-square"></i> fa-git-square</div>
      ...
      <div class="span3"><i class="fa fa-pied-piper"></i> fa-pied-piper</div>
      <div class="span3"><i class="fa fa-pied-piper-alt"></i> fa-pied-piper-alt</div>
      <div class="span3"><i class="fa fa-pied-piper-square"></i> fa-pied-piper-square <span class="text-muted">(alias)</span></div>
      ...
      <div class="span3"><i class="fa fa-qq"></i> fa-qq</div>
      <div class="span3"><i class="fa fa-ra"></i> fa-ra <span class="text-muted">(alias)</span></div>
      <div class="span3"><i class="fa fa-rebel"></i> fa-rebel</div>
      <div class="span3"><i class="fa fa-reddit"></i> fa-reddit</div>
      <div class="span3"><i class="fa fa-reddit-square"></i> fa-reddit-square</div>
      ...
      <div class="span3"><i class="fa fa-wechat"></i> fa-wechat <span class="text-muted">(alias)</span></div>
