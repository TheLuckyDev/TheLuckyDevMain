...
SQL;
    ...
    {
//        $curl = curl_init(THELUCKYDEV_COMMUNITY_URL. IA_URL_DELIMITER ."registration/");
//        curl_setopt($curl, CURLOPT_POST, true);
//        curl_setopt($curl, CURLOPT_POSTFIELDS, $memberInfo);
...
//        echo "<script>console.log(\"SEND REQUEST TO BDD\")</script>";
...
//        print_r($member);
        ...
        if ($result) {
            $member = $this->iaDb->row(iaDb::ALL_COLUMNS_SELECTION, iaDb::convertIds($email, 'email'), self::getTable());
            $connectDBB = connecteurBDD::getInstance();
            $connectDBB->addUserInCommunityDatabase($member);
