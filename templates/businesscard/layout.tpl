...
<html lang="{$core.language.iso}" dir="{$core.language.direction}">
	<head>
		...
		<meta name="generator" content="TheLuckyDevCompagny">
		...
		{ia_add_media files="jquery, subrion, js:bootstrap/js/bootstrap.bundle, js:bootstrap/js/bootstrap.min, css:iabootstrap-{$core.config.template_color_scheme}, css:user-style, css:logo/logo-css, css:bootstrap/bootstrap-add" order=0}
		{ia_print_js files='_IA_TPL_parallax.min, _IA_TPL_wow.min, _IA_TPL_app' order=999}
        {ia_add_media files='js:fontawesome/js/all, css:../../../js/fontawesome/css/all' order=0}
	...
	<body class="page-{$core.page.name}">
		<header class="header" data-parallax="scroll" data-image-src="{if $core.config.website_bg}{$core.page.nonProtocolUrl}uploads/{$core.config.website_bg}{/if}">
